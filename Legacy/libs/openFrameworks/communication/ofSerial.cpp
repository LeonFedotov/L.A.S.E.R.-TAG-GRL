...
//----------------------------------------------------------------
int ofSerial::writeBytes(string str){
	...
	//---------------------------------------------
		...
		if(numWritten == 0 && len > 0) printf("ofSerial: Can't write to com port");
		else{
			if (bVerbose){
...
//----------------------------------------------------------------
string ofSerial::readBytes(int length){
	...
	//---------------------------------------------
		...
		if(nRead == 0)printf("ofSerial: trouble reading from port\n");
...
//----------------------------------------------------------------
unsigned char ofSerial::readByte(){
